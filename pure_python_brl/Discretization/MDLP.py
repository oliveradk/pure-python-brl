...
import pandas as pd
import numpy as np
from pure_python_brl.Discretization.Entropy import entropy, cut_point_information_gain
...
class MDLP_Discretizer(object):
    def __init__(self, dataset, class_label, out_path_data=None, out_path_bins=None, features=None):
        ...
        #self._data = self._data.convert_objects(convert_numeric=True) TODO: see if I need to uncomment
